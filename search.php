...
if ($_REQUEST['act'] == 'advanced_search')
{
	...
	$smarty->assign('cate',       $cate['cate']); // 分类树
...
else
{
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_name,g.original_img, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
    ...
    while ($row = $db->FetchRow($res))
    {
		...
		$arr[$row['goods_id']]['goods_name0'] = $row['goods_name'];
