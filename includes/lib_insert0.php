...
function insert_ads($arr)
{
    ...
    else
    {
        ...
        {
            $sql  = 'SELECT a.ad_id, a.position_id, a.media_type, a.ad_link, a.ad_code, a.ad_link1, a.ad_code1, a.ad_link2, a.ad_code2, a.ad_link3, a.ad_code3, a.ad_link4, a.ad_code4, a.ad_name, p.ad_width, '.
                        'p.ad_height, p.position_style, RAND() AS rnd ' .
                    'FROM ' . $GLOBALS['ecs']->table('ad') . ' AS a '.
                    'LEFT JOIN ' . $GLOBALS['ecs']->table('ad_position') . ' AS p ON a.position_id = p.position_id ' .
 ...
 $ads[] = '<div class="bannerbox">
    <div id="focus">
        <ul>
            <li><a href="' .$row["ad_link"]. '" target="_blank">
                <img src="'.$src.'" alt="" style="width:100%;" /></a></li>
            <li><a href="' .$row["ad_link1"]. '" target="_blank">
                <img src="'.$src1.'" alt="" style="width:100%;" /></a></li>
            <li><a href="' .$row["ad_link2"]. '" target="_blank">
                <img src="'.$src2.'" alt=""  style="width:100%;"/></a></li>
            <li><a href="' .$row["ad_link3"]. '" target="_blank">
                <img src="'.$src3.'" alt="" style="width:100%;" /></a></li>
			<li><a href="' .$row["ad_link4"]. '" target="_blank">
                <img src="'.$src4.'" alt="" style="width:100%;"/></a></li>
        </ul>
		<div class="btnBg" style="opacity: 0;"></div><div class="btn"><span style="opacity: 0.4;"></span><span style="opacity: 0.4;"></span><span style="opacity: 0.4;"></span><span style="opacity: 0.4;"></span><span style="opacity: 1;"></span></div><div class="preNext pre" style="opacity: 0;"></div><div class="preNext next" style="opacity: 0;"></div></div>
    </div>
</div>
<script type="text/javascript" src="/themes/ecmoban_meilishuo/js/simplefoucs.js"></script>'
;				
...
;*/				
		...
		$vas = array(ad_link => $row["ad_link"],ad_code => $src,ad_link1 => $row["ad_link"] ,ad_code1 => $src ,ad_link2 =>$row["ad_link"] ,ad_code2 =>$src,ad_link3 => $row["ad_link"] ,ad_code3 => $src ,ad_link4 =>$row["ad_link"] ,'ad_code4' => $src );
