...
?></span> <span onclick="AddFavorite('我的网站',location.href)" style=" cursor:pointer;">收藏本站</span><div class="app_pos">您是第<span class="p_num"><?php 
$k = array (
  'name' => 'ip',
);
echo $this->_echash . $k['name'] . '|' . serialize($k) . $this->_echash;
...
<div class="header_logo">
  ...
  <dl class="se_1">
    ...
    <dd>热门搜索:<?php if ($this->_var['searchkeywords']): ?>
            <?php $_from = $this->_var['searchkeywords']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'searchkeywords_0_52119500_1451355528');if (count($_from)):
    foreach ($_from AS $this->_var['searchkeywords_0_52119500_1451355528']):
?>
             	<a href="search.php?keywords=<?php echo $this->_var['searchkeywords_0_52119500_1451355528']; ?>"><?php echo $this->_var['searchkeywords_0_52119500_1451355528']; ?></a>
...
<div class="nav_0">
  <div class="nav">
    <ul>
      ...
      <li class="nav-item"><a href="/article.php?id=36" target="_blank">关于我们</a></li>
      <li class="nav-item"><a href="/article_list.php?id=23" target="_blank">新闻动态</a></li>
      <li class="nav-item"><a href="/article_list.php?id=24" target="_blank">公司公告</a></li>
      <li class="nav-item"><a href="/user.php?act=message_list" target="_blank">互动留言</a></li>
      <li class="nav-item"><a href="/article.php?id=200" target="_blank">采购须知</a></li>
      <li class="nav-item"><a href="/user.php" target="_blank">会员登录</a></li>
      <li class="nav-item"><a href="article_list.php?category=15" target="_blank">装修效果</a></li>
    </ul>
