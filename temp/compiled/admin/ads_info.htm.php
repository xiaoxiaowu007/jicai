...
<form action="ads.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
  ...
  <?php if ($this->_var['ads']['media_type'] == 0 || $this->_var['action'] == "add"): ?>
    <tbody id="0">
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['ad_link']; ?>1</td>
      <td>
  ...
  <?php if ($this->_var['ads']['media_type'] == 0 || $this->_var['action'] == "add"): ?>
    <tbody id="0">
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['ad_link']; ?>2</td>
      <td>
        <input type="text" name="ad_link1" value="<?php echo $this->_var['ads']['ad_link1']; ?>" size="35" />
      </td>
    </tr>
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_img']; ?></td>
      <td>
        <input type='file' name='ad_img1' size='35' />
        <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="AdCodeImg"><?php echo $this->_var['lang']['ad_code_img']; ?></span>
      </td>
    </tr>
    <tr style="display:none;">
      <td  class="label"><?php echo $this->_var['lang']['img_url']; ?>1</td>
      <td><input type="text" name="img_url1" value="<?php echo $this->_var['url_src1']; ?>" size="35" /></td>
    </tr>
    </tbody>
  <?php endif; ?>
  ...
  <?php if ($this->_var['ads']['media_type'] == 0 || $this->_var['action'] == "add"): ?>
    <tbody id="0">
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['ad_link']; ?>3</td>
      <td>
        <input type="text" name="ad_link2" value="<?php echo $this->_var['ads']['ad_link2']; ?>" size="35" />
      </td>
    </tr>
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_img']; ?></td>
      <td>
        <input type='file' name='ad_img2' size='35' />
        <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="AdCodeImg"><?php echo $this->_var['lang']['ad_code_img']; ?></span>
      </td>
    </tr>
    <tr style="display:none;">
      <td  class="label"><?php echo $this->_var['lang']['img_url']; ?>3</td>
      <td><input type="text" name="img_url2" value="<?php echo $this->_var['url_src2']; ?>" size="35" /></td>
    </tr>
    </tbody>
  <?php endif; ?>
    ...
    <tbody id="0">
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['ad_link']; ?>4</td>
      <td>
        <input type="text" name="ad_link3" value="<?php echo $this->_var['ads']['ad_link3']; ?>" size="35"/>
      </td>
    </tr>
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_img']; ?></td>
      <td>
        <input type='file' name='ad_img3' size='35' />
        <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="AdCodeImg"><?php echo $this->_var['lang']['ad_code_img']; ?></span>
      </td>
    </tr>
    <tr style="display:none;">
      <td  class="label"><?php echo $this->_var['lang']['img_url']; ?>4</td>
      <td><input type="text" name="img_url3" value="<?php echo $this->_var['url_src3']; ?>" size="35" /></td>
    </tr>
    </tbody>
  <?php endif; ?>
    ...
    <tbody id="0">
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['ad_link']; ?>5</td>
      <td>
        <input type="text" name="ad_link4" value="<?php echo $this->_var['ads']['ad_link4']; ?>" size="35" />
      </td>
    </tr>
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_img']; ?></td>
      <td>
        <input type='file' name='ad_img4' size='35' />
        <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="AdCodeImg"><?php echo $this->_var['lang']['ad_code_img']; ?></span>
      </td>
    </tr>
    <tr style="display:none;">
      <td  class="label"><?php echo $this->_var['lang']['img_url']; ?>5</td>
      <td><input type="text" name="img_url4" value="<?php echo $this->_var['url_src4']; ?>" size="35" /></td>
    </tr>
    </tbody>
  <?php endif; ?>
