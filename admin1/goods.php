        ...
        foreach ($goods_attr_list as $attr_id => $attr_value_list)
        {
            foreach ($attr_value_list as $attr_value => $info)
            {
                if ($info['sign'] == 'insert')
                {
                    ...
                    $sql = "INSERT INTO " .$ecs->table('goods_attr'). " (attr_id, goods_id, attr_value, attr_price,attr_img,attr_order)".
                            "VALUES ('$attr_id', '$goods_id', '$attr_value', '$info[attr_price]','$info[attr_img]','$info[attr_order]')";
                ...
                elseif ($info['sign'] == 'update')
                {
					if($info['attr_img'] == ""){
						...
						$sql = "UPDATE " .$ecs->table('goods_attr'). " SET attr_price = '$info[attr_price]',attr_img = '$info[attr_img]',attr_order = '$info[attr_order]' WHERE goods_attr_id = '$info[goods_attr_id]' LIMIT 1";
					}
                }
                else
                {
