...
//console.log(location.href.substring((location.href.lastIndexOf("/")) + 1, location.href.lastIndexOf("?")));
 ...
 * 翻页
 */
listTable.gotoPage_ssj = function(page)
{
  if (page != null) this.filter['page'] = page;
 ...
 * 载入列表
 */
listTable.loadList_ssj = function()
{
  var args = "act=query_ssj" + this.compileFilter();
...
listTable.gotoPageFirst_ssj = function()
{
  if (this.filter.page > 1)
  {
    listTable.gotoPage_ssj(1);
  }
}
...
listTable.gotoPagePrev_ssj = function()
{
  if (this.filter.page > 1)
  {
    listTable.gotoPage_ssj(this.filter.page - 1);
  }
}
...
listTable.gotoPageNext_ssj = function()
{
  if (this.filter.page < listTable.pageCount)
  {
    listTable.gotoPage_ssj(parseInt(this.filter.page) + 1);
  }
}
...
listTable.gotoPageLast_ssj = function()
{
  if (this.filter.page < listTable.pageCount)
  {
    listTable.gotoPage_ssj(listTable.pageCount);
  }
}
