...
elseif ($_REQUEST['act'] == 'signin')
{
    ...
    {
         /* 检查密码是否正确 */
         $sql = "SELECT user_id, user_name, password, last_login,rank_id,action_list, last_login,suppliers_id,rank_id_goods,ec_salt".
    ...
    {
         /* 检查密码是否正确 */
         $sql = "SELECT user_id, user_name, password, last_login,rank_id,rank_id_goods,action_list, last_login,suppliers_id,ec_salt".
            " FROM " . $ecs->table('admin_user') .
