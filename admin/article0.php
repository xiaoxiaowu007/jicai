...
if ($_REQUEST['act'] == 'sjs_list')
{
	...
	var_dump($rank_id_res);
	
	$rank_num = count($rank_id_res);
    ...
    $article_list = get_sjs_articleslist($rank_fan);
...
if ($_REQUEST['act'] == 'insert0')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('ssj')." (ssj_name, cat_id, address, telphone,ssj_area,content) ".
            "VALUES ('$_POST[ssj_name]', '$_POST[cat_id]', '$_POST[address]', '$_POST[telphone]', '$_POST[ssj_area]','$_POST[FCKeditor1]')";
    $db->query($sql);
...
if ($_REQUEST['act'] =='update0')
{
    ...
    if ($exc->edit0("ssj_name='$_POST[ssj_name]', cat_id='$_POST[cat_id]', address='$_POST[address]', telphone='$_POST[telphone]',ssj_area='$_POST[ssj_area]',content='$_POST[FCKeditor1]'", $_POST['id']))
    {
        $link[0]['text'] = $_LANG['back_list'];
