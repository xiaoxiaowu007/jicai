...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $ad_link1 = !empty($_POST['ad_link1']) ? trim($_POST['ad_link1']) : '';
	$ad_link2 = !empty($_POST['ad_link2']) ? trim($_POST['ad_link2']) : '';
	$ad_link3 = !empty($_POST['ad_link3']) ? trim($_POST['ad_link3']) : '';
	$ad_link4 = !empty($_POST['ad_link4']) ? trim($_POST['ad_link4']) : '';
    ...
    if ($_POST['media_type'] == '0')
    {
		...
		//图片2
        if ((isset($_FILES['ad_img1']['error']) && $_FILES['ad_img1']['error'] == 0) || (!isset($_FILES['ad_img1']['error']) && isset($_FILES['ad_img1']['tmp_name'] ) &&$_FILES['ad_img1']['tmp_name'] != 'none'))
        {
            $ad_code1 = basename($image->upload_image($_FILES['ad_img1'], 'afficheimg'));
        }
        if (!empty($_POST['img_url1']))
        {
            $ad_code1 = $_POST['img_url1'];
        }
        if (((isset($_FILES['ad_img1']['error']) && $_FILES['ad_img1']['error'] > 0) || (!isset($_FILES['ad_img1']['error']) && isset($_FILES['ad_img1']['tmp_name']) && $_FILES['ad_img1']['tmp_name'] == 'none')) && empty($_POST['img_url1']))
        {
            $link[] = array('text' => $_LANG['go_back'], 'href' => 'javascript:history.back(-1)');
            sys_msg($_LANG['js_languages']['ad_photo_empty'], 0, $link);
        }
		...
		//图片3
        if ((isset($_FILES['ad_img2']['error']) && $_FILES['ad_img2']['error'] == 0) || (!isset($_FILES['ad_img2']['error']) && isset($_FILES['ad_img2']['tmp_name'] ) &&$_FILES['ad_img2']['tmp_name'] != 'none'))
        {
            $ad_code2 = basename($image->upload_image($_FILES['ad_img2'], 'afficheimg'));
        }
        if (!empty($_POST['img_url2']))
        {
            $ad_code2 = $_POST['img_url2'];
        }
        if (((isset($_FILES['ad_img2']['error']) && $_FILES['ad_img2']['error'] > 0) || (!isset($_FILES['ad_img2']['error']) && isset($_FILES['ad_img2']['tmp_name']) && $_FILES['ad_img2']['tmp_name'] == 'none')) && empty($_POST['img_url2']))
        {
            $link[] = array('text' => $_LANG['go_back'], 'href' => 'javascript:history.back(-1)');
            sys_msg($_LANG['js_languages']['ad_photo_empty'], 0, $link);
        }
		...
		//图片4
        if ((isset($_FILES['ad_img3']['error']) && $_FILES['ad_img3']['error'] == 0) || (!isset($_FILES['ad_img3']['error']) && isset($_FILES['ad_img3']['tmp_name'] ) &&$_FILES['ad_img3']['tmp_name'] != 'none'))
        {
            $ad_code3 = basename($image->upload_image($_FILES['ad_img3'], 'afficheimg'));
        }
        if (!empty($_POST['img_url3']))
        {
            $ad_code3 = $_POST['img_url3'];
        }
        if (((isset($_FILES['ad_img3']['error']) && $_FILES['ad_img3']['error'] > 0) || (!isset($_FILES['ad_img3']['error']) && isset($_FILES['ad_img3']['tmp_name']) && $_FILES['ad_img3']['tmp_name'] == 'none')) && empty($_POST['img_url3']))
        {
            $link[] = array('text' => $_LANG['go_back'], 'href' => 'javascript:history.back(-1)');
            sys_msg($_LANG['js_languages']['ad_photo_empty'], 0, $link);
        }
		...
		//图片5
        if ((isset($_FILES['ad_img4']['error']) && $_FILES['ad_img4']['error'] == 0) || (!isset($_FILES['ad_img4']['error']) && isset($_FILES['ad_img4']['tmp_name'] ) &&$_FILES['ad_img4']['tmp_name'] != 'none'))
        {
            $ad_code4 = basename($image->upload_image($_FILES['ad_img4'], 'afficheimg'));
        }
        if (!empty($_POST['img_url4']))
        {
            $ad_code4 = $_POST['img_url4'];
        }
        if (((isset($_FILES['ad_img4']['error']) && $_FILES['ad_img4']['error'] > 0) || (!isset($_FILES['ad_img4']['error']) && isset($_FILES['ad_img4']['tmp_name']) && $_FILES['ad_img4']['tmp_name'] == 'none')) && empty($_POST['img_url4']))
        {
            $link[] = array('text' => $_LANG['go_back'], 'href' => 'javascript:history.back(-1)');
            sys_msg($_LANG['js_languages']['ad_photo_empty'], 0, $link);
        }
...
/*        if (!empty($_POST['ad_text']))
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,ad_link1,ad_code1,ad_link2,ad_code2,ad_link3,ad_code3,ad_link4,ad_code4,start_time,end_time,link_man,link_email,link_phone,click_count,enabled)
...
elseif ($_REQUEST['act'] == 'update')
{
   ...
   $ad_link4 = !empty($_POST['ad_link4']) ? trim($_POST['ad_link4']) : '';
    ...
    if ($type == 0)
    {
        ...
        if ((isset($_FILES['ad_img1']['error']) && $_FILES['ad_img1']['error'] == 0) || (!isset($_FILES['ad_img1']['error']) && isset($_FILES['ad_img1']['tmp_name']) && $_FILES['ad_img1']['tmp_name'] != 'none'))
        {
            $img_up_info1 = basename($image->upload_image($_FILES['ad_img1'], 'afficheimg'));
            $ad_code1 = "ad_code1 = '".$img_up_info1."'".',';
        }
        else
        {
            $ad_code1 = '';
        ...
        if (!empty($_POST['img_url1']))
        {
            $ad_code1 = "ad_code1 = '$_POST[img_url1]', ";
        }
		
		//图片3
        if ((isset($_FILES['ad_img2']['error']) && $_FILES['ad_img2']['error'] == 0) || (!isset($_FILES['ad_img2']['error']) && isset($_FILES['ad_img2']['tmp_name']) && $_FILES['ad_img2']['tmp_name'] != 'none'))
        {
            $img_up_info2 = basename($image->upload_image($_FILES['ad_img2'], 'afficheimg'));
            $ad_code2 = "ad_code2 = '".$img_up_info2."'".',';
        }
        else
        {
            $ad_code2 = '';
        ...
        if (!empty($_POST['img_url2']))
        {
            $ad_code2 = "ad_code2 = '$_POST[img_url2]', ";
        }
        ...
        if ((isset($_FILES['ad_img3']['error']) && $_FILES['ad_img3']['error'] == 0) || (!isset($_FILES['ad_img3']['error']) && isset($_FILES['ad_img3']['tmp_name']) && $_FILES['ad_img3']['tmp_name'] != 'none'))
        {
            $img_up_info3 = basename($image->upload_image($_FILES['ad_img3'], 'afficheimg'));
            $ad_code3 = "ad_code3 = '".$img_up_info3."'".',';
        }
        else
        {
            $ad_code3 = '';
        ...
        if (!empty($_POST['img_url3']))
        {
            $ad_code3 = "ad_code3 = '$_POST[img_url3]',";
        }
		
		//图片5
        if ((isset($_FILES['ad_img4']['error']) && $_FILES['ad_img4']['error'] == 0) || (!isset($_FILES['ad_img4']['error']) && isset($_FILES['ad_img4']['tmp_name']) && $_FILES['ad_img4']['tmp_name'] != 'none'))
        {
            $img_up_info4 = basename($image->upload_image($_FILES['ad_img4'], 'afficheimg'));
            $ad_code4 = "ad_code4 = '".$img_up_info4."'".',';
        }
        else
        {
            $ad_code4 = '';
        ...
        if (!empty($_POST['img_url4']))
        {
            $ad_code4 = "ad_code4 = '$_POST[img_url4]', ";
        }
    ...
    $sql = "UPDATE " .$ecs->table('ad'). " SET ".
			...
			"ad_link3     = '$ad_link3', ".
			"ad_link4     = '$ad_link4', ".
            $ad_code.$ad_code1.$ad_code2.$ad_code3.$ad_code4.
